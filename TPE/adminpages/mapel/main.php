...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
					...
					<div class="x_content">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									<th width="5%">No</th>
									<th width="15%">Nama Mata Pelajaran</th>
									<th width="5%">Aksi</th>
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>mapel/form_edit.php?id_mapel=<?php echo $data['id_mapel'];?>">
													<button class="btn btn-warning">
														<i class="fa fa-edit"></i>
													</button></a>
									<a href="<?php echo $admin_url; ?>mapel/hapus.php?id_mapel=<?php echo $data['id_mapel'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>mapel/form_tambah.php">
