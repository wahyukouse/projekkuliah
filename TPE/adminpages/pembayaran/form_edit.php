...
if (empty($_SESSION['username'])) {
  ...
  $query = $koneksi->query("SELECT * FROM pembayaran WHERE id_pembayaran = '$id'");
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <form method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="aksi_edit.php" enctype="multipart/form-data">
                <input type="hidden" value="<?php echo$data['id_pembayaran']; ?>" name="id">
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-10 col-xs-12">
                    <input type="text" class="form-control col-md-7 col-xs-12" name="jenis" value="<?php echo$data['jenis']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-10 col-xs-12">
                    <input type="number" class="form-control col-md-7 col-xs-12" name="biaya" value="<?php echo$data['biaya']; ?>">
                  </div>
                </div>
