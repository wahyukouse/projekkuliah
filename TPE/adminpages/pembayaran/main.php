...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									...
									<th width="15%">Biaya Pembayaran</th>
									<th width="5%">Aksi</th>
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>pembayaran/form_edit.php?id_pembayaran=<?php echo $data['id_pembayaran'];?>">
													<button class="btn btn-warning">
														<i class="fa fa-edit"></i>
													</button></a>
									<a href="<?php echo $admin_url; ?>pembayaran/hapus.php?id_pembayaran=<?php echo $data['id_pembayaran'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>pembayaran/form_tambah.php">
