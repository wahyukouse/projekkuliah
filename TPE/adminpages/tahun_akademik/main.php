							...
							<div class="x_content">
									...
									<tbody>
										...
										foreach ($dataTable as $i => $data)
										{
											...
											<tr>
												...
												<td><a href="form_edit.php?id_tahun=<?php echo $data['id_tahun'];?>">
													<button class="btn btn-warning">
														<i class="fa fa-edit"></i>
													</button></a>
													<a href="hapus.php?id_tahun=<?php echo $data['id_tahun'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
								...
								<div class="col-xs-12">
									<a href="form_tambah.php">
										<button class="btn btn-primary" onClick="return confirm('Peringatan!!! Jika Anda Menambah Tahun Ajaran Status Siswa Semua Akan Dirubah Menjadi Tidak Aktif')">
