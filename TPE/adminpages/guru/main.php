...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
					...
					<div class="x_content">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>guru/form_edit.php?nip=<?php echo $data['nip'];?>">
								<button class="btn btn-warning">
									<i class="fa fa-edit"></i>
								</button></a>
								
								<a href="<?php echo $admin_url; ?>guru/hapus.php?nip=<?php echo $data['nip'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>guru/form_tambah.php">
