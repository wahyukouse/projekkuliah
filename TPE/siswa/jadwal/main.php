						...
						<table class="table table-striped">
							...
							<tbody>
								...
								while (	$data = mysqli_fetch_array($query)) {
									...
									<?php $no++;} ?>
									<tr align="center"><td colspan="5"><a href="../report/cetak_jadwal.php?id=<?php echo $_POST['tahun'] ; ?>&&nisn=<?php echo $_SESSION['nisn'] ; ?>&&sms=<?php echo $_POST['semester'] ; ?>" class="cetak">Cetak</a></td></tr>
								</tbody>
							</table>
							<?php }else{ ?>
